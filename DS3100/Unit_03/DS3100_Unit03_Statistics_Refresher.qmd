...
Larger samples generally produce **smaller standard errors**: $SE (\text{for sample mean}) = \frac{s}{\sqrt{n}}$
...
The significance level is tied to <span style="color:#1565C0;">Type I error rate</span>. It is area of the null distribution inside the rejection region. 
$\alpha=P(\text{reject }H_0\mid H_0\text{ true})$

Power is related to <span style="color:#1565C0;">Type II error rate</span> ($\beta$). It is the area of the alternative distribution inside that same rejection region. $\text{Power}=1-\beta$
...
#### 💡 The exact assumptions matter, but the following remains valid:
...
In general, a **test statistic** tells us how far an observed sample statistic is from the value expected by $H_0$ in terms of standard errors, relative to its expected sampling variation.
