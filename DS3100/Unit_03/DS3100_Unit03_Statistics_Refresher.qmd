...
<br>The significance level is tied to <span style="color:#1565C0;">Type I error rate</span>:

$$
\alpha=P(\text{reject }H_0\mid H_0\text{ true})
$$

Power is related to <span style="color:#1565C0;">Type II error rate</span> ($\beta$):
...
::: {.callout-note style="font-size:0.62em;"}
Do not memorize a universal rule such as "n < 30 means use the t-test." The deeper distinction is whether the population SD is known or estimated, together with the assumptions of the test.
:::
